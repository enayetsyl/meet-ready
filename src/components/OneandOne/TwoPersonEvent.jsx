...
{/* <button onClick={()=>setNext1(!next1)} className="btn">Next</button> */}
    ...
    <p className="text-sm">Set your availability during the week.</p>
     ...
     <div className="flex gap-3">
             ...
             <div className="space-y-4">
                ...
                <select className="select select-bordered select-xs w-[100px] my-3 max-w-xs">
  ...
  <option>Friday</option>
              ...
              <div className="">
                ...
                <select className="select select-bordered select-xs w-[105px] my-3 max-w-xs">
  ...
  <option value='' >12:00 PM</option>
    ...
    <p className="text-sm">Make some Time For Your Meeting</p>
     <input className="w-[380px] outline-none border border-slate-400 h-[40px] rounded-md hover:border-blue-400 p-2" type='date'  name=''></input>
</div>
